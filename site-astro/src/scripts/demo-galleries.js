...
// instead of the bundled v2 UMD globals. Body below is ported verbatim
// from site/assets/js/app.js (id-guarded per demo, exactly as before);
...
// element-guarded and only run on their own demo pages.
