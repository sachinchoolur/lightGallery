...
description: 'Free under GPLv3. For proprietary projects choose a commercial license, one-time or annual plans for solo developers, teams and organizations.'
        ...
        <div class="container-xl pricing-section">
            ...
            <div class="pricing-list justify-content-center">
                <div class="pricing-list-item pricing-list-item-colored">
                    ...
                    <div class="pricing-cost">
                        <span data-kq-price="extended-sub" data-kq-period="YEARLY">$239</span> <span class="pricing-cost-label">/ year <span class="pricing-original"></span></span>
                    </div>
                    <div class="d-grid pricing-btn-wrap">
    ...
    <div class="pricing-tab-content" id="pricing-onetime">
        <div class="pricing-list justify-content-center">
            ...
            <div class="pricing-list-item">
                <div class="pricing-type">Team</div>
                <div class="pricing-cost">
                    <span  data-kq-price="team" data-kq-period="ONE_TIME">$118</span> <span class="pricing-cost-label">/ lifetime <span class="pricing-original"></span></span>
                </div>
                <div class="pricing-desc">
                    For small teams.
                </div>
            ...
            <div class="pricing-list-item">
                <div class="pricing-type">Organization</div>
                <div class="pricing-cost">
                    <span data-kq-price="organization" data-kq-period="ONE_TIME">$188</span> <span class="pricing-cost-label">/ lifetime <span class="pricing-original"></span></span>
                </div>
                <div class="pricing-desc">
                    For large teams and organizations
                </div>
        ...
        <div class="container-xl pricing-section">
            ...
            <div class="pricing-list justify-content-center">
                <div class="pricing-list-item pricing-list-item-colored">
                    <div class="pricing-type">Extended</div>
                    <div class="pricing-cost">
                        <span data-kq-price="extended" data-kq-period="ONE_TIME">$99</span> <span class="pricing-cost-label">/ lifetime <span class="pricing-original"></span></span>
                    </div>
                    <div class="d-grid pricing-btn-wrap">
