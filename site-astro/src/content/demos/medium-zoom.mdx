...
// Triggers are components here, so there is no `selector` to match, // wrap the images you want zoomable.
<LightGallery plugins={[MediumZoom]} mediumZoom={{ margin: 24 }}>
    {images.map((image) => (
        <LightGalleryItem key={image.src} item={image}>
...
<template>
    <LightGallery :plugins="[MediumZoom]" :medium-zoom="{ margin: 24 }">
        <LgItem v-for="image of images" :key="image.src" :item="image">
            <img :src="image.thumb" :alt="image.alt" />
        </LgItem>
    </LightGallery>
</template>
...
```html
<lg-gallery [features]="[withMediumZoom({ margin: 24 })]">
    @for (image of images; track image.src) {
        <a [lgGalleryItem]="image">
            <img [src]="image.thumb" [alt]="image.alt" />
        </a>
    }
</lg-gallery>
...
<figure lg-background-color="#FFF" class="blog-images" data-src="/img/photos/facade/01-2400.avif"  data-lg-size="1600-1126" >
<img alt="office building with symmetrical gray textured walls" src="/img/photos/facade/01-1200.avif"/>
</figure>
...
<figure lg-background-color="rgb(22 37 44)" style="float:left" class="blog-images" data-src="/img/photos/facade/02-2400.avif"  data-lg-size="1600-1067" >
<img alt="gray and black architectural design" src="/img/photos/facade/02-1200.avif"/>
</figure>
...
<figure lg-background-color="rgb(28 62 74)" class="blog-images" data-src="/img/photos/facade/03-2400.avif"  data-lg-size="1600-2400" style="float: right; margin-left: 2rem;">
<img alt="a very tall building with lots of windows" src="/img/photos/facade/03-1200.avif"/>
</figure>
