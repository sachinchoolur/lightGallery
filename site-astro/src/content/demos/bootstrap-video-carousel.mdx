---
title: 'Bootstrap video carousel with lightbox'
description: 'Bootstrap video carousel demo, slide through YouTube, Vimeo and HTML5 videos and open any of them in a full-screen lightbox player.'
lead:
...
images: []
has_video: true
menu: { demos: { parent: 'Demos', name: 'Bootstrap video carousel' } }
weight: 25
toc: true
---
