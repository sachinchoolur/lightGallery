...
import ImageGalleryPicture from '../../components/shortcodes/ImageGalleryPicture.astro';
import ImageGallerySrcset from '../../components/shortcodes/ImageGallerySrcset.astro';
...
can use native srcset and sizes attributes. Please refer the next demo, and the
...
<ImageGallery id="gallery-captions-demo" />

<CodeTabs codepen="https://codepen.io/sachinchoolur/pen/OJpXJda" stackblitz="https://stackblitz.com/edit/stackblitz-starters-v7wpeb">
...
```tsx
// Per-item breakpoints, the same contract as data-responsive.
const slides = [
    {
        src: 'img/1-1600.jpg',
        responsive: 'img/1-480.jpg 480, img/1-800.jpg 800',
        thumb: 'img/1-240.jpg',
        lgSize: '1600-1067',
    },
];
...
<div class="alert alert-info" role="alert">If you want srcset to be supported for older browser please include <a href="http://caniuse.com/#feat=video" target="_blank">picturefil</a> javascript library in your document.</div>

lightGallery will automatically call picturefil library if it is available

<ImageGallerySrcset id="gallery-srcset-demo" />
...
```tsx
// srcset/sizes ride along on the item and land on the slide <img>.
const slides = [
    {
        src: 'img/1-1600.jpg',
        srcset: 'img/1-480.jpg 480w, img/1-800.jpg 800w, img/1-1600.jpg 1600w',
        sizes: '(max-width: 480px) 480px, (max-width: 800px) 800px, 1600px',
        thumb: 'img/1-240.jpg',
    },
];
...
<ImageGalleryPicture id="gallery-picture-demo" />
