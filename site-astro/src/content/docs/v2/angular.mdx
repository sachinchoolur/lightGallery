---
title: 'lightGallery 2.x Angular wrapper (archive)'
description: 'Archived documentation for the lightGallery 2.x Angular wrapper. Version 3 ships a native Angular package, see the migration guide.'
lead: 'Documentation for the legacy 2.x Angular wrapper, kept for projects that have not migrated yet.'
