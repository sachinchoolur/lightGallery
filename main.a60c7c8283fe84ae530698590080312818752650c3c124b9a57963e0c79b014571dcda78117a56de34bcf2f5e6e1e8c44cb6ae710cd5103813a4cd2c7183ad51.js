...
;
/*!
 * lightgallery | 2.3.0-beta.1 | September 6th 2021
    ...
    var Video = /** @class */ (function () {
        ...
        Video.prototype.getVideoHtml = function (src, addClass, index, html5Video) {
            ...
            if (videoInfo.youtube) {
                ...
                var slideUrlParams = videoInfo.vimeo[2]
                    ? videoInfo.vimeo[2] + '&'
                    : '';
                console.log(slideUrlParams);
