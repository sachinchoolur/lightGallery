    ...
    ***************************************************************************** */
    ...
    var LightGallery = /** @class */ (function () {
        ...
        LightGallery.prototype.init = function () {
            ...
            if (this.settings.dynamic) {
                var index_1 = this.settings.index || 0;
                setTimeout(function () {
        ...
        LightGallery.prototype.buildStructure = function () {
            ...
            if (this.settings.download) {
                this.outer
                    .find('.lg-toolbar')
                    .append("<a id=\"" + this.getIdName('lg-download') + "\" target=\"_blank\" aria-label=\"Download\" download class=\"lg-download lg-icon\"></a>");
            }
            this.counter();
        ...
        LightGallery.prototype.getMediaContainerPosition = function () {
            ...
            var top = this.outer.find('.lg-toolbar').get().clientHeight || 0;
...
(function (global, factory) {
    ...
    var CommentBox = /** @class */ (function () {
        ...
        CommentBox.prototype.setMarkup = function () {
            this.core.outer
                .find('.lg')
                .append(this.settings.fbCommentsMarkup +
...
;
"use strict";jQuery('#gallery-demo-zoom-from-origin').justifiedGallery({lastRow:'nojustify',rowHeight:180,margins:5}).on('jg.complete',function(){window.lightGallery(document.getElementById('gallery-demo-zoom-from-origin'),{pager:false,hash:false,zoomFromOrigin:true,allowMediaOverlap:false,preload:0,mode:'lg-fade'});});const lgContainer=document.getElementById('inline-gallery-container');window.lightGallery(lgContainer,{container:lgContainer,dynamic:true,thumbnail:true,swipeToClose:false,hash:false,pager:false,closable:false,showMaximizeIcon:true,slideDelay:400,appendSubHtmlTo:'.lg-item',mobileSettings:{showCloseIcon:false},dynamicEl:[{src:'https://images.unsplash.com/photo-1609342122563-a43ac8917a3a?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1600&q=80',thumb:'https://images.unsplash.com/photo-1609342122563-a43ac8917a3a?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=240&q=100',subHtml:"<div class=\"lightGallery-captions\">\n                <h4>Caption 1</h4>\n                <p>Description of the slide 1</p>\n            </div>"},{src:'https://images.unsplash.com/photo-1505820013142-f86a3439c5b2?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1600&q=80',thumb:'https://images.unsplash.com/photo-1505820013142-f86a3439c5b2?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=240&q=100',subHtml:"<div class=\"lightGallery-captions\">\n                <h4>Caption 2</h4>\n                <p>Description of the slide 2</p>\n            </div>"},{src:'https://images.unsplash.com/photo-1477322524744-0eece9e79640?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1600&q=80',thumb:'https://images.unsplash.com/photo-1477322524744-0eece9e79640?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=240&q=100'},{src:'https://images.unsplash.com/photo-1469474968028-56623f02e42e?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1600&q=80',thumb:'https://images.unsplash.com/photo-1469474968028-56623f02e42e?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=240&q=100'}]});window.lightGallery(document.getElementById('gallery-demo-animated-thumbnails'),{pager:false,hash:false});jQuery('#animated-thumbnails-gallery').justifiedGallery({lastRow:'nojustify',rowHeight:180,margins:5}).on('jg.complete',function(){window.lightGallery(document.getElementById('animated-thumbnails-gallery'),{autoplayFirstVideo:false,pager:false,hash:false,preload:3,videoMaxWidth:'1400px'});});jQuery('#static-thumbnails-gallery').justifiedGallery({lastRow:'nojustify',rowHeight:180,margins:5}).on('jg.complete',function(){window.lightGallery(document.getElementById('static-thumbnails-gallery'),{animateThumb:false,pager:false,hash:false,zoomFromOrigin:false,allowMediaOverlap:true});});jQuery('#customize-thumbnails-gallery').justifiedGallery({lastRow:'nojustify',rowHeight:180,margins:5}).on('jg.complete',function(){window.lightGallery(document.getElementById('customize-thumbnails-gallery'),{animateThumb:false,addClass:'lg-custom-thumbnails',pager:false,hash:false,toggleThumb:false,allowMediaOverlap:true});});const $galleryEventsDemo=jQuery('#gallery-events-demo');const galleryEventsDemo=$galleryEventsDemo[0];if(galleryEventsDemo){const colours=['#6a7583','#1e304b','#315460','#080607'];galleryEventsDemo.addEventListener('beforeSlide',event=>{const{index}=event.detail;document.querySelector('.lg-backdrop').style.backgroundColor=colours[index];});$galleryEventsDemo.justifiedGallery({lastRow:'nojustify',rowHeight:180,margins:5}).on('jg.complete',function(){window.lightGallery(galleryEventsDemo,{zoom:false,thumbnail:false,addClass:'lg-events-demo-outer',rotate:false,pager:false,hash:false,fullScreen:false,download:false});});}
let customTransitionsGallery;function customTransitions(trans){jQuery('#gallery-transitions-demo').justifiedGallery({lastRow:'nojustify',rowHeight:180,margins:5}).on('jg.complete',function(){customTransitionsGallery=window.lightGallery(document.getElementById('gallery-transitions-demo'),{mode:trans,zoom:false,thumbnail:false,rotate:false,pager:false,hash:false,fullScreen:false,download:false});});}
customTransitions('lg-slide');jQuery('#select-trans').on('change',function(){customTransitionsGallery.destroy();jQuery('#gallery-transitions-demo').justifiedGallery('destroy');jQuery('#gallery-transitions-demo').off('jg.complete');customTransitions(jQuery(this).val());});let customEasingGallery;function initCustomEasing(easing){jQuery('#gallery-custom-easing-demo').justifiedGallery({lastRow:'nojustify',rowHeight:180,margins:5}).on('jg.complete',function(){customEasingGallery=window.lightGallery(document.getElementById('gallery-custom-easing-demo'),{easing:easing,zoom:false,thumbnail:false,rotate:false,pager:false,hash:false,speed:1000,fullScreen:false,download:false});});}
initCustomEasing('cubic-bezier(0.680, -0.550, 0.265, 1.550)');jQuery('#select-easing').on('change',function(){const val=jQuery(this).val();prompt('You can copy cubic-bezier from here',val);customEasingGallery.destroy();jQuery('#gallery-custom-easing-demo').justifiedGallery('destroy');jQuery('#gallery-custom-easing-demo').off('jg.complete');initCustomEasing('cubic-bezier('+val+')');});let methodsInstance;const $lgGalleryMethodsDemo=document.getElementById('gallery-methods-demo');if($lgGalleryMethodsDemo){$lgGalleryMethodsDemo.addEventListener('init',()=>{const previousBtn='<button type="button" aria-label="Previous slide" class="lg-prev"> Prev Slide </button>';const nextBtn='<button type="button" aria-label="Next slide" class="lg-next"> Next Slide </button>';const $lgContainer=document.querySelector('.lg');$lgContainer.insertAdjacentHTML('beforeend',nextBtn);$lgContainer.insertAdjacentHTML('beforeend',previousBtn);document.querySelector('.lg-next').addEventListener('click',()=>{methodsInstance.goToNextSlide();});document.querySelector('.lg-prev').addEventListener('click',()=>{methodsInstance.goToPrevSlide();});});jQuery('#gallery-methods-demo').justifiedGallery({lastRow:'nojustify',rowHeight:180,margins:5}).on('jg.complete',function(){methodsInstance=window.lightGallery($lgGalleryMethodsDemo,{zoom:false,thumbnail:false,rotate:false,fullScreen:false,addClass:'lg-methods-demo',controls:false,download:false,pager:false,hash:false});});}
const $lgDemoUpdateSlides=jQuery('#gallery-update-slides-demo');const lgDemoUpdateSlides=$lgDemoUpdateSlides.get(0);let slidesUpdated=false;if(lgDemoUpdateSlides){lgDemoUpdateSlides.addEventListener('afterClose',event=>{if(slidesUpdated){setTimeout(()=>{$lgDemoUpdateSlides.justifiedGallery('destroy');$lgDemoUpdateSlides.off('jg.complete');event.detail.instance.destroy();},100);setTimeout(()=>{$lgDemoUpdateSlides.justifiedGallery({lastRow:'nojustify',rowHeight:180,margins:5}).on('jg.complete',function(){window.lightGallery(lgDemoUpdateSlides,{addClass:'lg-update-slide-demo',controls:false,download:false,pager:false,hash:false});});slidesUpdated=false;},200);}});lgDemoUpdateSlides.addEventListener('init',event=>{let updateSlideInstance=event.detail.instance;const addBtn='<button type="button" aria-label="Add slide" class="lg-icon" id="lg-add"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M23 12c0-3.037-1.232-5.789-3.222-7.778s-4.741-3.222-7.778-3.222-5.789 1.232-7.778 3.222-3.222 4.741-3.222 7.778 1.232 5.789 3.222 7.778 4.741 3.222 7.778 3.222 5.789-1.232 7.778-3.222 3.222-4.741 3.222-7.778zM21 12c0 2.486-1.006 4.734-2.636 6.364s-3.878 2.636-6.364 2.636-4.734-1.006-6.364-2.636-2.636-3.878-2.636-6.364 1.006-4.734 2.636-6.364 3.878-2.636 6.364-2.636 4.734 1.006 6.364 2.636 2.636 3.878 2.636 6.364zM8 13h3v3c0 0.552 0.448 1 1 1s1-0.448 1-1v-3h3c0.552 0 1-0.448 1-1s-0.448-1-1-1h-3v-3c0-0.552-0.448-1-1-1s-1 0.448-1 1v3h-3c-0.552 0-1 0.448-1 1s0.448 1 1 1z"></path></svg></button>';const deleteBtn='<button class="lg-icon" type="button" aria-label="Remove slide" class="lg-icon" id="lg-delete"> <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M23 12c0-3.037-1.232-5.789-3.222-7.778s-4.741-3.222-7.778-3.222-5.789 1.232-7.778 3.222-3.222 4.741-3.222 7.778 1.232 5.789 3.222 7.778 4.741 3.222 7.778 3.222 5.789-1.232 7.778-3.222 3.222-4.741 3.222-7.778zM21 12c0 2.486-1.006 4.734-2.636 6.364s-3.878 2.636-6.364 2.636-4.734-1.006-6.364-2.636-2.636-3.878-2.636-6.364 1.006-4.734 2.636-6.364 3.878-2.636 6.364-2.636 4.734 1.006 6.364 2.636 2.636 3.878 2.636 6.364zM8 13h8c0.552 0 1-0.448 1-1s-0.448-1-1-1h-8c-0.552 0-1 0.448-1 1s0.448 1 1 1z"></path></svg></button>';updateSlideInstance.outer.find('.lg-toolbar').append(deleteBtn);updateSlideInstance.outer.find('.lg-toolbar').append(addBtn);updateSlideInstance.outer.find('#lg-add').on('click',()=>{let galleryItems=[...updateSlideInstance.galleryItems,...[{src:'https://images.unsplash.com/photo-1609342122563-a43ac8917a3a?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1600&q=80',thumb:'https://images.unsplash.com/photo-1609342122563-a43ac8917a3a?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=240&q=100',subHtml:"<div class=\"lightGallery-captions\">\n                    <h4>Caption 1</h4>\n                    <p>Description of the slide 1</p>\n                </div>"}]];$lgDemoUpdateSlides.append("<a\n            data-lg-size=\"1600-1067\"\n            data-src=\"https://images.unsplash.com/photo-1609342122563-a43ac8917a3a?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1600&q=80\"\n            data-sub-html=\"<h4>Fading Light</h4><p>layers of blue.</p>\"\n        >\n            <img\n                alt=\"Captions\"\n                style=\"height: 200px; max-width: none; width: 200px\"\n                class=\"img-responsive\"\n                src=\"https://images.unsplash.com/photo-1609342122563-a43ac8917a3a?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=240&q=100\"\n            />\n        </a>");updateSlideInstance.updateSlides(galleryItems,updateSlideInstance.index);slidesUpdated=true;});updateSlideInstance.outer.find('#lg-delete').on('click',()=>{let galleryItems=JSON.parse(JSON.stringify(updateSlideInstance.galleryItems));galleryItems.shift();updateSlideInstance.updateSlides(galleryItems,1);$lgDemoUpdateSlides.children().first().remove();slidesUpdated=true;});});const jG=$lgDemoUpdateSlides.justifiedGallery({lastRow:'nojustify',rowHeight:180,margins:5});jG.on('jg.complete',function(){window.lightGallery(lgDemoUpdateSlides,{addClass:'lg-update-slide-demo',controls:false,pager:false,hash:false,download:false});});}
const $dynamicGallery=jQuery('#dynamic-gallery-demo');$dynamicGallery.on('click',function(){window.lightGallery($dynamicGallery[0],{dynamic:true,hash:false,pager:false,thumbnail:false,rotate:false,index:2,dynamicEl:[{src:'https://images.unsplash.com/photo-1609342122563-a43ac8917a3a?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1600&q=80',thumb:'https://images.unsplash.com/photo-1609342122563-a43ac8917a3a?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=240&q=100',subHtml:"<div class=\"lightGallery-captions\">\n                    <h4>Caption 1</h4>\n                    <p>Description of the slide 1</p>\n                </div>"},{src:'https://images.unsplash.com/photo-1505820013142-f86a3439c5b2?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1600&q=80',thumb:'https://images.unsplash.com/photo-1505820013142-f86a3439c5b2?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=240&q=100',subHtml:"<div class=\"lightGallery-captions\">\n                    <h4>Caption 2</h4>\n                    <p>Description of the slide 2</p>\n                </div>"},{src:'https://images.unsplash.com/photo-1477322524744-0eece9e79640?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1600&q=80',thumb:'https://images.unsplash.com/photo-1477322524744-0eece9e79640?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=240&q=100'},{src:'https://images.unsplash.com/photo-1469474968028-56623f02e42e?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1600&q=80',thumb:'https://images.unsplash.com/photo-1469474968028-56623f02e42e?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=240&q=100'}]});});window.lightGallery(document.getElementById('open-website'),{selector:'this'});window.lightGallery(document.getElementById('open-google-map'),{selector:'this'});window.lightGallery(document.getElementById('open-pdf'),{selector:'this'});jQuery('#gallery-videos-demo').justifiedGallery({lastRow:'nojustify',rowHeight:180,margins:5}).on('jg.complete',function(){window.lightGallery(document.getElementById('gallery-videos-demo'),{thumbnail:false,pager:false,hash:false,preload:0});});jQuery('#gallery-videojs-demo').justifiedGallery({lastRow:'nojustify',rowHeight:180,margins:5}).on('jg.complete',function(){window.lightGallery(document.getElementById('gallery-videojs-demo'),{pager:false,hash:false,preload:0,videojs:true,videojsOptions:{muted:true}});});jQuery('#gallery-hash-demo').justifiedGallery({lastRow:'nojustify',rowHeight:180,margins:5}).on('jg.complete',function(){window.lightGallery(document.getElementById('gallery-hash-demo'),{thumbnail:false,pager:false,galleryId:1,customSlideName:false});});jQuery('#gallery-custom-hash-demo').justifiedGallery({lastRow:'nojustify',rowHeight:180,margins:5}).on('jg.complete',function(){window.lightGallery(document.getElementById('gallery-custom-hash-demo'),{thumbnail:false,galleryId:2,pager:false,customSlideName:true});});jQuery('#gallery-share-demo').justifiedGallery({lastRow:'nojustify',rowHeight:180,margins:5}).on('jg.complete',function(){window.lightGallery(document.getElementById('gallery-share-demo'),{thumbnail:false,pager:false,hash:true});});jQuery('#gallery-captions-demo').justifiedGallery({lastRow:'nojustify',rowHeight:180,margins:5}).on('jg.complete',function(){window.lightGallery(document.getElementById('gallery-captions-demo'),{thumbnail:false,pager:false,hash:true});});jQuery('#gallery-mixed-content-demo').justifiedGallery({lastRow:'nojustify',rowHeight:180,margins:5}).on('jg.complete',function(){window.lightGallery(document.getElementById('gallery-mixed-content-demo'),{thumbnail:false,pager:false,hash:true});});jQuery('#gallery-share-reddit-demo').justifiedGallery({lastRow:'nojustify',rowHeight:180,margins:5}).on('jg.complete',function(){window.lightGallery(document.getElementById('gallery-share-reddit-demo'),{thumbnail:false,pager:false,hash:true,galleryId:2,addClass:'lg-custom-share-demo',extraProps:['redditTitle'],additionalShareOptions:[{selector:'.lg-share-reddit',dropdownHTML:'<li class="lg-share-item-reddit"><a class="lg-share-reddit" target="_blank"><svg class="lg-reddit" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><title>reddit</title><path d="M8 20c0-1.105 0.895-2 2-2s2 0.895 2 2c0 1.105-0.895 2-2 2s-2-0.895-2-2zM20 20c0-1.105 0.895-2 2-2s2 0.895 2 2c0 1.105-0.895 2-2 2s-2-0.895-2-2zM20.097 24.274c0.515-0.406 1.262-0.317 1.668 0.198s0.317 1.262-0.198 1.668c-1.434 1.13-3.619 1.86-5.567 1.86s-4.133-0.73-5.567-1.86c-0.515-0.406-0.604-1.153-0.198-1.668s1.153-0.604 1.668-0.198c0.826 0.651 2.46 1.351 4.097 1.351s3.271-0.7 4.097-1.351zM32 16c0-2.209-1.791-4-4-4-1.504 0-2.812 0.83-3.495 2.057-2.056-1.125-4.561-1.851-7.29-2.019l2.387-5.36 4.569 1.319c0.411 1.167 1.522 2.004 2.83 2.004 1.657 0 3-1.343 3-3s-1.343-3-3-3c-1.142 0-2.136 0.639-2.642 1.579l-5.091-1.47c-0.57-0.164-1.173 0.116-1.414 0.658l-3.243 7.282c-2.661 0.187-5.102 0.907-7.114 2.007-0.683-1.227-1.993-2.056-3.496-2.056-2.209 0-4 1.791-4 4 0 1.635 0.981 3.039 2.387 3.659-0.252 0.751-0.387 1.535-0.387 2.341 0 5.523 6.268 10 14 10s14-4.477 14-10c0-0.806-0.134-1.589-0.387-2.34 1.405-0.62 2.387-2.025 2.387-3.66zM27 5.875c0.621 0 1.125 0.504 1.125 1.125s-0.504 1.125-1.125 1.125-1.125-0.504-1.125-1.125 0.504-1.125 1.125-1.125zM2 16c0-1.103 0.897-2 2-2 0.797 0 1.487 0.469 1.808 1.145-1.045 0.793-1.911 1.707-2.552 2.711-0.735-0.296-1.256-1.016-1.256-1.856zM16 29.625c-6.42 0-11.625-3.414-11.625-7.625s5.205-7.625 11.625-7.625c6.42 0 11.625 3.414 11.625 7.625s-5.205 7.625-11.625 7.625zM28.744 17.856c-0.641-1.003-1.507-1.918-2.552-2.711 0.321-0.676 1.011-1.145 1.808-1.145 1.103 0 2 0.897 2 2 0 0.84-0.52 1.56-1.256 1.856z"></path></svg><span class="lg-dropdown-text">Reddit</span></a></li>',generateLink:galleryItem=>{const url=encodeURIComponent(window.location.href);const title=galleryItem.redditTitle;const redditShareLink="//reddit.com/submit?url=".concat(url,"&title=").concat(title);return redditShareLink;}}]});});