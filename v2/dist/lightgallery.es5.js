...
var LightGallery = /** @class */ (function () {
    ...
    LightGallery.prototype.getItems = function () {
        ...
        if (!this.s.dynamic) {
            ...
            return utils.getDynamicOptions(this.items, this.s.extraProps, this.s.getCaptionFromTitleOrAlt);
        }
        else {
    ...
    */
    ...
    LightGallery.prototype.touchEnd = function (endCoords, startCoords) {
        ...
        setTimeout(function () {
            ...
            if (_this.swipeDirection === 'horizontal') {
                ...
                if (_this.s.closable && distance > 100) {
                    _this.destroy();
                    return;
                }
                else {
    ...
    LightGallery.prototype.keyPress = function () {
        var _this = this;
        if (this.galleryItems.length > 1) {
            LG(window).on("keyup.lg.global" + this.lgId, function (e) {
