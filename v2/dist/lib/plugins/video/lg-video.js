...
var Video = /** @class */ (function () {
    function Video(instance) {
        this.core = instance;
        this.s = Object.assign({}, lg_video_settings_1.videoDefaults);
        this.init();
        return this;
    }
    Video.prototype.init = function () {
        ...
        this.core.LGel.on('onAferAppendSlide.lg.tm', this.onAferAppendSlide.bind(this));
        console.log('calling video');
        if (this.core.doCss() &&
            this.core.galleryItems.length > 1 &&
            (this.core.s.enableSwipe || this.core.s.enableDrag)) {
            this.core.LGel.on('onSlideClick.lg.tm', function () {
                console.log('calling');
    ...
    Video.prototype.onHasVideo = function (event) {
        var _a = event.detail, index = _a.index, src = _a.src, html = _a.html, hasPoster = _a.hasPoster;
    ...
    Video.prototype.getVideoHtml = function (src, addClass, index, html5video) {
        ...
        if (videoInfo.youtube) {
            ...
            video = "<iframe id=" + videoId + " class=\"lg-video-object lg-youtube " + addClass + "\" " + videoTitle + " src=\"//www.youtube.com/embed/" + (videoInfo.youtube[1] + playerParams) + "\" " + commonIframeProps + "></iframe>";
        }
        else if (videoInfo.vimeo) {
            var videoId = 'lg-vimeo' + index;
            var playerParams = param(this.s.vimeoPlayerParams);
            video = "<iframe id=" + videoId + " class=\"lg-video-object lg-vimeo " + addClass + "\" " + videoTitle + " src=\"//player.vimeo.com/video/" + (videoInfo.vimeo[1] + playerParams) + "\" " + commonIframeProps + "></iframe>";
        }
        else if (videoInfo.wistia) {
            var wistiaId = 'lg-wistia' + index;
            var playerParams = param(this.s.wistiaPlayerParams);
            video = "<iframe id=\"" + wistiaId + "\" src=\"//fast.wistia.net/embed/iframe/" + (videoInfo.wistia[4] + playerParams) + "\" " + videoTitle + " class=\"wistia_embed lg-video-object lg-wistia " + addClass + "\" name=\"wistia_embed\" " + commonIframeProps + "></iframe>";
        }
        ...
        if (this.s.gotoNextSlideOnVideoEnd) {
            if (videoInfo.html5) {
                ...
                try {
                    ...
                    console.error('lightGallery:- Make sure you have included https://www.youtube.com/iframe_api');
                }
            }
            else if (videoInfo.vimeo) {
                try {
                    ...
                    console.error('lightGallery:- Make sure you have included https://github.com/vimeo/player.js');
                }
            }
            else if (videoInfo.wistia) {
                try {
