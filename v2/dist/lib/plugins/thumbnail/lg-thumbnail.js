...
var Thumbnail = /** @class */ (function () {
    function Thumbnail(instance) {
        ...
        this.s = Object.assign({}, lg_thumbnail_settings_1.thumbnailsDefaults);
        this.init();
        return this;
    }
    ...
    Thumbnail.prototype.build = function () {
        ...
        LG(this.core.el).on('onBeforeSlide.lg-tm', function (e) {
            console.log(e, e.detail);
            _this.animateThumb(_this.core.index);
        });
        this.core.LGel.on('appendSlides.lg-tm', function (e) {
            _this.addNewThumbnails(e.detail.items);
        });
        LG(window).on('resize.lg.thumb orientationchange.lg.thumb', function () {
    ...
    Thumbnail.prototype.enableThumbDrag = function () {
        ...
        LG(window).on('mousemove.lg.thumb', function (e) {
            if (isDragging) {
                thumbDragUtils.cords.endX = e.pageX;
                thumbDragUtils = _this.onThumbTouchMove(thumbDragUtils);
            }
        });
        LG(window).on('mouseup.lg.thumb', function () {
    ...
    Thumbnail.prototype.thumbKeyPress = function () {
        var _this = this;
        LG(window).on('keydown.lg.thumb', function (e) {
            if (!_this.core.lgOpened)
                return;
            if (e.keyCode === 38) {
                e.preventDefault();
